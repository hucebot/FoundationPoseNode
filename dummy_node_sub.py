...
def main():
    ...
    parser.add_argument("--rgb_topic", type=str, default="/rgbd/realsense_test/color/image_raw/compressed")
    parser.add_argument("--depth_topic", type=str, default="/rgbd/realsense_test/aligned_depth_to_color/image_raw/compressedDepth")
